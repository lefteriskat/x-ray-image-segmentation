...
class Utils:
    ...
    def get_model(self):
        if self.config.model.name == "unet":
            return UNetBlocked(in_channels=self.config.model.unet_in_channels,
                               out_channels=self.config.model.unet_out_channels, unet_block=self.config.model.unet_block)
        else:
